...
export const TIMETABLE_SLOTS: TimetableSlot[] = [
  ...
  { type: 'single', time: '5:20', orderIndex: 6,         duration: '22분' },
  { type: 'single', time: '5:42', orderIndex: 7,         duration: '8분' },
  { type: 'single', time: '5:50', orderIndex: 8,         duration: '15분' },
  { type: 'single', time: '6:05', orderIndex: 9,         duration: '20분' },
  { type: 'single', time: '6:25', orderIndex: 10,        duration: '10분' },
